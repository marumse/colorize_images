...
if __name__ == '__main__':
    path = '/net/projects/scratch/winter/valid_until_31_July_2020/asparagus/malin/colorize_images/code/reduce_colors.py'
    ...
    learning_rates = [0.01] #, 0.01, 0.05, 0.08, 0.001]
    names = ['0.01'] #, '0.01', '0.05','0.08', '0.001']
