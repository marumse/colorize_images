...
if __name__ == "__main__":
    ...
    if mode == 'train':
        ...
        # save model checkpoints for security
        checkpoint = ModelCheckpoint(str(name)+'.hdf5', monitor='loss', verbose=1, save_best_only=True, mode='auto', period=1)
        # fit model
    ...
    if mode == 'predict':
        ...
        model.load_weights('/home/student/s/sschulzewedd/'+ str(name) +'.hdf5')
